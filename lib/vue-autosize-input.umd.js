(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory() } else if (typeof define === 'function' && define.amd) { define([], factory) } else if (typeof exports === 'object') { exports['vue-autosize-input'] = factory() } else { root['vue-autosize-input'] = factory() }
...
*/
  ...
  Function('return this')()
    ...
    __webpack_require__.p = src[1] // eslint-disable-line
      ...
      // CONCATENATED MODULE: ./src/AutosizeInput.js
      ...
      var INPUT_PROPS_BLACKLIST = ['minWidth', 'extraWidth', 'placeholderIsMinWidth', 'injectStyles', 'inputClass', 'inputStyle', 'sizeChange']
      ...
      var getListeners = function getListeners (context) {
      ...
      var AutosizeInput = {
        ...
        watch: {
          ...
          inputWidth: function inputWidth (val, oldVal) {
            if (val !== oldVal) {
        ...
        methods: {
          ...
          updateInputWidth: function updateInputWidth () {
            ...
            var extraWidth = this.$attrs.type === 'number' && this.extraWidth === undefined ? 16 : parseInt(this.extraWidth) || 0
        ...
        render: function render (h) {
          ...
          return h('div', {
          ...
          }, [isIE && this.injectStyles ? h('style', 'input#'.concat(this.inputId, '::-ms-clear {display: none;}')) : null, h('input', {
            ref: 'input',
            class: this.inputClass,
            ...
            attrs: _objectSpread2(_objectSpread2({}, inputProps), this.$attrs),
            props: inputProps,
            on: _objectSpread2(_objectSpread2({}, getListeners(this)), {}, {
              input: function input (e) {
                _this2.$emit('input', e.target.value)
            ...
            ref: 'sizer',
            style: sizerStyle,
          }, this.value), this.placeholder ? h('div', {
      ...
      if (typeof window !== 'undefined' && 'Vue' in window) {
        window.Vue.component('input-autosize', AutosizeInput)
      }

      /* harmony default export */ var src_AutosizeInput = (AutosizeInput)
      // CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js

      /* harmony default export */ var entry_lib = __webpack_exports__.default = (src_AutosizeInput)
      /***/ },
...
// # sourceMappingURL=vue-autosize-input.umd.js.map
